...
<li>Phone Name:</li><li><input type="text" name="Phonename" /></li>
...
$sql = "INSERT INTO Phone(Phoneid, Phonename)"
        . " VALUES('$_POST[Phoneid]','$_POST[Phonename]')";
$stmt = $pdo->prepare($sql);
//$stmt->execute();
 if (is_null($_POST[Phoneid])) {
   echo "PhoneID must be not null";
 }
 else
 {
